...
public class StateTest {
    ...
    public void parsesOpeningBookMovesForTheCurrentPosition() {
        ...
        List<Move> moves = state.lookupNextMove(new ByteArrayInputStream(
                openingBook.getBytes(StandardCharsets.UTF_8)));
